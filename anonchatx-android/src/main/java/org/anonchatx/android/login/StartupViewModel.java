package org.anonchatx.android.login;
...
import org.anonchatsecure.bramble.api.lifecycle.LifecycleManager.LifecycleState;
import org.anonchatsecure.bramble.api.lifecycle.event.LifecycleEvent;
...
import static org.anonchatsecure.bramble.api.lifecycle.LifecycleManager.LifecycleState.COMPACTING_DATABASE;
import static org.anonchatsecure.bramble.api.lifecycle.LifecycleManager.LifecycleState.MIGRATING_DATABASE;
import static org.anonchatsecure.bramble.api.lifecycle.LifecycleManager.LifecycleState.STARTING_SERVICES;
import static org.anonchatx.android.login.StartupViewModel.State.COMPACTING;
import static org.anonchatx.android.login.StartupViewModel.State.MIGRATING;
import static org.anonchatx.android.login.StartupViewModel.State.SIGNED_IN;
import static org.anonchatx.android.login.StartupViewModel.State.SIGNED_OUT;
import static org.anonchatx.android.login.StartupViewModel.State.STARTED;
import static org.anonchatx.android.login.StartupViewModel.State.STARTING;
