...
import org.anonchatx.android.AnonChatService;
...
import org.anonchatx.android.login.StartupViewModel.State;
...
public class StartupActivity extends BaseActivity implements
	...
	private void onStateChanged(State state) {
		if (state == SIGNED_OUT) {
			...
			startService(new Intent(this, AnonChatService.class));
