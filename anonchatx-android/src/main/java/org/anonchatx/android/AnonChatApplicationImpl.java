...
import org.anonchatx.android.util.VoiceCacheCleaner;
...
import static org.anonchatx.android.settings.DisplayFragment.PREF_THEME;

public class AnonChatApplicationImpl extends Application
		implements AnonChatApplication {

	private static final Logger LOG =
			getLogger(AnonChatApplicationImpl.class.getName());
	...
	private void setTheme(Context ctx, SharedPreferences prefs) {
		...
		if (theme == null) {
			// set default value to DARK mode instead of system
