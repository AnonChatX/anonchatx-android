package org.anonchatx.android.contact.add.nearby;
...
import org.anonchatsecure.bramble.api.keyagreement.KeyAgreementResult;
...
import org.anonchatsecure.bramble.api.keyagreement.event.KeyAgreementAbortedEvent;
import org.anonchatsecure.bramble.api.keyagreement.event.KeyAgreementFailedEvent;
import org.anonchatsecure.bramble.api.keyagreement.event.KeyAgreementFinishedEvent;
import org.anonchatsecure.bramble.api.keyagreement.event.KeyAgreementListeningEvent;
import org.anonchatsecure.bramble.api.keyagreement.event.KeyAgreementStartedEvent;
import org.anonchatsecure.bramble.api.keyagreement.event.KeyAgreementWaitingEvent;
import org.anonchatsecure.bramble.api.lifecycle.IoExecutor;
import org.anonchatsecure.bramble.api.plugin.BluetoothConstants;
import org.anonchatsecure.bramble.api.plugin.LanTcpConstants;
...
import org.anonchatsecure.bramble.api.plugin.event.TransportStateEvent;
import org.anonchatsecure.bramble.api.qrcode.WrongQrCodeTypeException;
import org.anonchatsecure.bramble.api.system.AndroidExecutor;
import org.anonchatsecure.bramble.plugin.bluetooth.BluetoothPlugin;
import org.anonchatx.R;
import org.anonchatx.android.contact.add.nearby.AddContactState.ContactExchangeFinished;
import org.anonchatx.android.contact.add.nearby.AddContactState.ContactExchangeResult.Error;
import org.anonchatx.android.contact.add.nearby.AddContactState.ContactExchangeResult.Success;
import org.anonchatx.android.contact.add.nearby.AddContactState.ContactExchangeStarted;
import org.anonchatx.android.contact.add.nearby.AddContactState.Failed;
import org.anonchatx.android.contact.add.nearby.AddContactState.Failed.WrongQrCodeType;
import org.anonchatx.android.contact.add.nearby.AddContactState.Failed.WrongQrCodeVersion;
import org.anonchatx.android.contact.add.nearby.AddContactState.KeyAgreementListening;
import org.anonchatx.android.contact.add.nearby.AddContactState.KeyAgreementStarted;
import org.anonchatx.android.contact.add.nearby.AddContactState.KeyAgreementWaiting;
import org.anonchatx.android.contact.add.nearby.AddContactState.QrCodeScanned;
import org.anonchatx.android.qrcode.QrCodeDecoder;
import org.anonchatx.android.qrcode.QrCodeUtils;
import org.anonchatx.android.viewmodel.LiveEvent;
import org.anonchatx.android.viewmodel.MutableLiveEvent;
...
import static org.anonchatsecure.bramble.api.plugin.Plugin.State.DISABLED;
import static org.anonchatsecure.bramble.api.plugin.Plugin.State.INACTIVE;
import static org.anonchatsecure.bramble.api.plugin.Plugin.State.STARTING_STOPPING;
import static org.anonchatsecure.bramble.util.AndroidUtils.registerReceiver;
import static org.anonchatsecure.bramble.util.LogUtils.logException;
import static org.anonchatsecure.bramble.util.StringUtils.ISO_8859_1;
import static org.anonchatx.android.contact.add.nearby.AddNearbyContactPermissionManager.areEssentialPermissionsGranted;
import static org.anonchatx.android.contact.add.nearby.AddNearbyContactViewModel.BluetoothDecision.NO_ADAPTER;
import static org.anonchatx.android.contact.add.nearby.AddNearbyContactViewModel.BluetoothDecision.REFUSED;
import static org.anonchatx.android.contact.add.nearby.AddNearbyContactViewModel.BluetoothDecision.UNKNOWN;
import static org.anonchatx.android.util.PermissionUtils.isLocationEnabledForBt;
import static org.anonchatx.android.util.UiUtils.handleException;
