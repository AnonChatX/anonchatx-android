...
import org.anonchatsecure.bramble.api.db.PendingContactExistsException;
...
public class NicknameFragment extends BaseFragment {
	...
	private void showSameLinkDialog(String name1, String name2,
		...
		Builder b = new Builder(ctx, R.style.AnonDialogTheme_Neutral);
	...
	private void showWarningDialog(String name1, String name2) {
		Context ctx = requireContext();
		Builder b = new Builder(ctx, R.style.AnonDialogTheme);
