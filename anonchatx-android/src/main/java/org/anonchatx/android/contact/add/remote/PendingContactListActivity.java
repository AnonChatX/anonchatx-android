...
import static org.anonchatsecure.bramble.api.contact.PendingContactState.FAILED;
import static org.anonchatx.android.contact.add.remote.PendingContactItem.POLL_DURATION_MS;
...
public class PendingContactListActivity extends BriarActivity
	...
	public void onCreate(@Nullable Bundle state) {
		...
		offlineSnackbar = new BriarSnackbarBuilder()
				.setBackgroundColor(R.color.anon_red_500)
	...
	public void onPendingContactItemRemoved(PendingContactItem item) {
		...
		MaterialAlertDialogBuilder builder = new MaterialAlertDialogBuilder(
				PendingContactListActivity.this, R.style.AnonDialogTheme);
		builder.setTitle(
