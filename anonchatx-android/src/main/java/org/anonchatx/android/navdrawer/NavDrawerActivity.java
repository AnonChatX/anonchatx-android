package org.anonchatx.android.navdrawer;
...
import org.anonchatx.android.AnonChatApplication;
...
import org.anonchatx.android.fragment.BaseFragment;
import org.anonchatx.android.fragment.BaseFragment.BaseFragmentListener;
import org.anonchatx.android.logout.SignOutFragment;
...
import static org.anonchatsecure.bramble.api.lifecycle.LifecycleManager.LifecycleState.RUNNING;
import static org.anonchatsecure.bramble.api.plugin.Plugin.State.ACTIVE;
import static org.anonchatsecure.bramble.api.plugin.Plugin.State.ENABLING;
import static org.anonchatsecure.bramble.api.plugin.Plugin.State.STARTING_STOPPING;
import static org.anonchatx.android.AnonChatService.EXTRA_STARTUP_FAILED;
import static org.anonchatx.android.AnonChatService.EXTRA_START_RESULT;
import static org.anonchatx.android.TestingConstants.IS_DEBUG_BUILD;
import static org.anonchatx.android.activity.RequestCodes.REQUEST_PASSWORD;
import static org.anonchatx.android.navdrawer.IntentRouter.handleExternalIntent;
import static org.anonchatx.android.util.UiUtils.getDaysUntilExpiry;
import static org.anonchatx.android.util.UiUtils.observeOnce;
import static org.anonchatx.android.util.UiUtils.resolveColorAttribute;
...
public class NavDrawerActivity extends BriarActivity implements
	...
	public static Uri CONTACT_URI =
			Uri.parse("briar-content://org.anonchatx/contact");
	public static Uri GROUP_URI =
			Uri.parse("briar-content://org.anonchatx/group");
	public static Uri FORUM_URI =
			Uri.parse("briar-content://org.anonchatx/forum");
	public static Uri BLOG_URI =
			Uri.parse("briar-content://org.anonchatx/blog");
	public static Uri CONTACT_ADDED_URI =
			Uri.parse("briar-content://org.anonchatx/contact/added");
	public static Uri SIGN_OUT_URI =
			Uri.parse("briar-content://org.anonchatx/sign-out");
	...
	private int getIconColor(State state) {
		if (state == ACTIVE) return R.color.anon_lime_400;
		else if (state == ENABLING) return R.color.anon_orange_500;
	...
	private void showTransportsOnboarding(ImageView imageView) {
		...
		new MaterialTapTargetPrompt.Builder(NavDrawerActivity.this,
				...
				.setBackgroundColour(
						ContextCompat.getColor(this, R.color.anon_primary))
				.show();
