...
import static org.anonchatsecure.bramble.api.plugin.TorConstants.REASON_BATTERY;
import static org.anonchatsecure.bramble.api.plugin.TorConstants.REASON_COUNTRY_BLOCKED;
import static org.anonchatsecure.bramble.api.plugin.TorConstants.REASON_MOBILE_DATA;
import static org.anonchatx.android.util.PermissionUtils.areBluetoothPermissionsGranted;
import static org.anonchatx.android.util.PermissionUtils.requestBluetoothPermissions;
import static org.anonchatx.android.util.PermissionUtils.showDenialDialog;
import static org.anonchatx.android.util.PermissionUtils.showRationale;
import static org.anonchatx.android.util.PermissionUtils.wasGrantedBluetoothPermissions;
import static org.anonchatx.android.util.UiUtils.showOnboardingDialog;
...
public class TransportsActivity extends BriarActivity {
	...
	private int getIconColor(State state) {
		if (state == ACTIVE) return R.color.anon_green_600;
