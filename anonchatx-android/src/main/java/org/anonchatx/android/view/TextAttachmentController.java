package org.anonchatx.android.view;
...
import org.anonchatx.android.attachment.AttachmentItemResult;
import org.anonchatx.android.attachment.AttachmentManager;
import org.anonchatx.android.attachment.AttachmentResult;
import org.anonchatx.android.view.ImagePreview.ImagePreviewListener;
...
public class TextAttachmentController extends TextSendController
	...
	protected void updateViewState() {
		...
		if (loadingUris) {
			...
			boolean showSend = hasImage || !textIsEmpty;
			sendButton.showSendButtonInstead(showSend, isSendButtonEnabled());

			if (hasImage) {
				sendButton.findViewById(R.id.imageButton).setVisibility(View.GONE);
				sendButton.findViewById(R.id.recordButton).setVisibility(View.GONE);
			} else {
				sendButton.findViewById(R.id.imageButton).setVisibility(View.VISIBLE);
				sendButton.findViewById(R.id.recordButton).setVisibility(View.VISIBLE);
			}
		}
	}
	...
	public void showImageOnboarding(Activity activity) {
		...
		new MaterialTapTargetPrompt.Builder(activity,
				...
				.setBackgroundColour(getColor(activity, R.color.anon_primary))
