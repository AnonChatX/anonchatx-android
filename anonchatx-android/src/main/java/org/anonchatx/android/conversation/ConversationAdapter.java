...
import org.anonchatx.android.util.BriarAdapter;
import org.anonchatx.android.util.ItemReturningAdapter;
	...
	public ConversationItemViewHolder onCreateViewHolder(ViewGroup viewGroup,
		...
		if (type == R.layout.list_item_conversation_msg_in ||
			...
			boolean isIncoming = (type == R.layout.list_item_conversation_msg_in ||
					...
					type == R.layout.list_item_conversation_msg_image_text ||
					type == R.layout.list_item_conversation_msg_audio_in);
			return new ConversationMessageViewHolder(v, listener, isIncoming,
					imageViewPool, imageItemDecoration, attachmentRetriever);
