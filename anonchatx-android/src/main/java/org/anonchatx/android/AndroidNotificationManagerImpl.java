...
import org.anonchatsecure.bramble.api.Multiset;
...
import org.anonchatsecure.bramble.api.mailbox.event.MailboxProblemEvent;
...
import org.anonchatsecure.bramble.api.settings.event.SettingsUpdatedEvent;
...
import org.anonchatx.android.util.BriarNotificationBuilder;
...
import org.anonchatsecure.anonchat.api.privategroup.event.GroupMessageAddedEvent;
...
import static org.anonchatx.android.conversation.ConversationActivity.CONTACT_ID;
import static org.anonchatx.android.navdrawer.NavDrawerActivity.BLOG_URI;
import static org.anonchatx.android.navdrawer.NavDrawerActivity.CONTACT_ADDED_URI;
import static org.anonchatx.android.navdrawer.NavDrawerActivity.CONTACT_URI;
import static org.anonchatx.android.navdrawer.NavDrawerActivity.FORUM_URI;
import static org.anonchatx.android.navdrawer.NavDrawerActivity.GROUP_URI;
import static org.anonchatx.android.settings.SettingsFragment.SETTINGS_NAMESPACE;
...
class AndroidNotificationManagerImpl implements AndroidNotificationManager,
	...
	private void createNotificationChannel(String channelId,
		...
		nc.setLightColor(getColor(appContext, R.color.anon_lime_400));
	...
	private Notification getForegroundNotification(boolean locked) {
		...
		b.setSmallIcon(icon);
		b.setColor(getColor(appContext, R.color.anon_primary));
	...
	public void showMailboxProblemNotification() {
		...
		b.setSmallIcon(R.drawable.notification_mailbox_old);
		b.setColor(getColor(appContext, R.color.anon_red_500));
		b.setContentTitle(
