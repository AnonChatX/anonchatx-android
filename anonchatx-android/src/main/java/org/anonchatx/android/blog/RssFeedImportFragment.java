...
import org.anonchatx.android.fragment.ProgressFragment;
import org.anonchatx.android.util.ActivityLaunchers.GetContentAdvanced;
import org.anonchatx.android.util.ActivityLaunchers.OpenDocumentAdvanced;
...
public class RssFeedImportFragment extends BaseFragment {
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		if (item.getItemId() == R.id.action_import_file) {
			launchActivityToOpenFile(requireContext(), docLauncher, contentLauncher, new String[] { "*/*" });
			return true;
		}
