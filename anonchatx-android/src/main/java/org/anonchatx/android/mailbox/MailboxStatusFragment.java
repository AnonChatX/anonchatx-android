...
import org.anonchatx.android.view.BriarButton;
...
import static org.anonchatsecure.bramble.api.mailbox.MailboxConstants.API_CLIENT_TOO_OLD;
import static org.anonchatx.android.AppModule.getAndroidComponent;
import static org.anonchatx.android.util.UiUtils.MIN_DATE_RESOLUTION;
import static org.anonchatx.android.util.UiUtils.formatDate;
...
public class MailboxStatusFragment extends Fragment {
	...
	private void onMailboxStateChanged(MailboxStatus status) {
		...
		if (status.getMailboxCompatibility() < 0) {
			...
			tintRes = R.color.anon_orange_500;
			showUnlinkWarning = false;
			wizardButton.setVisibility(VISIBLE);
		} else {
