...
import org.anonchatsecure.bramble.api.mailbox.MailboxPairingState.ConnectionError;
import org.anonchatsecure.bramble.api.mailbox.MailboxPairingState.InvalidQrCode;
import org.anonchatsecure.bramble.api.mailbox.MailboxPairingState.MailboxAlreadyPaired;
import org.anonchatsecure.bramble.api.mailbox.MailboxPairingState.Paired;
import org.anonchatsecure.bramble.api.mailbox.MailboxPairingState.Pending;
import org.anonchatsecure.bramble.api.mailbox.MailboxPairingState.UnexpectedError;
...
import org.anonchatx.android.fragment.FinalFragment;
import org.anonchatx.android.mailbox.MailboxState.CameraError;
import org.anonchatx.android.mailbox.MailboxState.IsPaired;
import org.anonchatx.android.mailbox.MailboxState.NotSetup;
import org.anonchatx.android.mailbox.MailboxState.OfflineWhenPairing;
import org.anonchatx.android.mailbox.MailboxState.Pairing;
import org.anonchatx.android.mailbox.MailboxState.ScanningQrCode;
import org.anonchatx.android.mailbox.MailboxState.ShowDownload;
import org.anonchatx.android.mailbox.MailboxState.WasUnpaired;
import org.anonchatx.android.view.BlankFragment;
...
import static org.anonchatsecure.bramble.api.mailbox.MailboxConstants.QR_FORMAT_VERSION;
import static org.anonchatsecure.bramble.api.qrcode.QrCodeClassifier.QrCodeType.BQP;
import static org.anonchatsecure.bramble.api.qrcode.QrCodeClassifier.QrCodeType.MAILBOX;
