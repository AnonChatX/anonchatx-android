...
import org.anonchatsecure.bramble.api.lifecycle.LifecycleManager.StartResult;
...
import org.anonchatx.android.logout.HideUiActivity;
...
import static org.anonchatsecure.bramble.api.lifecycle.LifecycleManager.StartResult.ALREADY_RUNNING;
import static org.anonchatsecure.bramble.api.lifecycle.LifecycleManager.StartResult.SUCCESS;
import static org.anonchatsecure.bramble.util.AndroidUtils.isUiThread;
import static org.anonchatx.android.AnonChatApplication.ENTRY_ACTIVITY;
import static org.anonchatsecure.anonchat.api.android.AndroidNotificationManager.ONGOING_CHANNEL_ID;
import static org.anonchatsecure.anonchat.api.android.AndroidNotificationManager.ONGOING_CHANNEL_OLD_ID;
import static org.anonchatsecure.anonchat.api.android.AndroidNotificationManager.ONGOING_NOTIFICATION_ID;
import static org.anonchatsecure.anonchat.api.android.LockManager.ACTION_LOCK;
import static org.anonchatsecure.anonchat.api.android.LockManager.EXTRA_PID;
import static org.briarproject.nullsafety.NullSafety.requireNonNull;

public class AnonChatService extends Service {

	public static String EXTRA_START_RESULT =
			"org.anonchatx.START_RESULT";
	public static String EXTRA_STARTUP_FAILED =
			"org.anonchatx.STARTUP_FAILED";

	private static final Logger LOG =
			Logger.getLogger(AnonChatService.class.getName());
	...
	private AnonChatApplication app;
	...
	public void onCreate() {
		...
		app = (AnonChatApplication) getApplication();
	...
	private void showStartupFailure(StartResult result) {
		androidExecutor.runOnUiThread(() -> {
			...
			Intent i = new Intent(AnonChatService.this, ENTRY_ACTIVITY);
	...
	public class BriarBinder extends Binder {
		 ...
		 */
		public AnonChatService getService() {
			return AnonChatService.this;
		}
	}

	public static class AnonchatServiceConnection implements ServiceConnection {
